...
//    @Pattern(regexp = "^\\d+$", message = "ID không hợp lệ")
    ...
    public CustomerAvartasDTO(Long id, String fullName, String email, String phone, BigDecimal balance, LocationRegion locationRegion, AvatarDTO avatarDTO) {
        this.id = id;
    ...
    public CustomerAvartasDTO(Long id, String fullName, String email,
                              String phone, BigDecimal balance, LocationRegion locationRegion,
